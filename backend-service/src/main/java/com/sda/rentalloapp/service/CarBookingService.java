...
public class CarBookingService {
    ...
    public long calculateFinalBookingPrice(LocalDate startDate,
        ...
        if (startDate.isAfter(endDate) || startDate.isEqual(endDate)) {
            throw new WrongDateInputException("Wrong dates provides, start date = [%s], end date = [%s]".formatted(startDate, endDate));
        }
        ...
        log.info("Price for booking car starting on [{}] ending on [{}] is [{}]", startDate, endDate, finalPriceInPolishGrosz);
